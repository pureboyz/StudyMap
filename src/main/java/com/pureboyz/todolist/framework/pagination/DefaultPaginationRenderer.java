 ...
 */
package com.pureboyz.todolist.framework.pagination;
...
public class DefaultPaginationRenderer extends AbstractPaginationRenderer {
	...
	public DefaultPaginationRenderer() {
        firstPageLabel = "<span class=\"first\"><a href=\"#\" onclick=\"{0}({1}); return false;\"></a></span>";
        previousPageLabel = "<span class=\"paging_prev\" ><a href=\"#\" onclick=\"{0}({1}); return false;\"></a></span>";
        currentPageLabel = "&#160;<a href=\"#\" class=\"on\">{0}</a>&#160;";
        otherPageLabel = "&#160;<a href=\"#\" onclick=\"{0}({1}); return false;\">{2}</a>&#160;";
        nextPageLabel = "<span class=\"paging_next\" onclick=\"{0}({1}); return false;\"><a href=\"#\"></a></span>";
        lastPageLabel = "<span class=\"paging_last\"><a href=\"#\" onclick=\"{0}({1}); return false;\"></a></span>";
	}
