...
public class PaginationInfo{
	...
	private int mysqlPage=-1;
	public int getRecordCountPerPage(){
		return recordCountPerPage<1?10:recordCountPerPage;
	}
	...
	public void setMysqlPage(int mysqlPage) {
		this.mysqlPage = mysqlPage;
	}
	public int getMysqlPage() {
		if(mysqlPage==-1) return (this.currentPageNo-1)*this.getRecordCountPerPage();
		return 0;
	}
	/**
	 * Not Required Fields
	...
	public int getViewRecordCount(){
		if(viewRecordCount==0){
			viewRecordCount=this.getTotalRecordCount()-this.getRecordCountPerPage()*(this.getCurrentPageNo()-1);
		}
